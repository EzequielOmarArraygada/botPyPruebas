    ...
    async def on_interaction(self, interaction: discord.Interaction):
        ...
        # --- Manejar sumisión de modals (FacturaAModal) ---
            ...
            try:
                ...
                pedido = interaction.data['components'][0]['components'][0]['value'].strip()
                caso = interaction.data['components'][1]['components'][0]['value'].strip()
                email = interaction.data['components'][2]['components'][0]['value'].strip()
                descripcion = interaction.data['components'][3]['components'][0]['value'].strip()
